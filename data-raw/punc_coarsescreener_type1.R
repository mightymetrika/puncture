## code to prepare `punc_coarsescreener_type1` dataset goes here

system.time(
  punc_coarsescreener_type1 <- puncture_lm_sim(
    n = 35,
    sim_iter = 500,
    beta_gen = function() {
      list(
...
usethis::use_data(punc_coarsescreener_type1, overwrite = TRUE)
