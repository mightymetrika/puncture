# data-raw/punc_recruit_pwr_med.R

## code to prepare `punc_recruit_pwr_med` dataset goes here

system.time(
  punc_recruit_pwr_med <- puncture_lm_sim(
    n = 25,
    sim_iter = 500,
    beta_gen = function() {
      list(
...
usethis::use_data(punc_recruit_pwr_med, overwrite = TRUE)
