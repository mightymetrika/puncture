## code to prepare `punc_recruit_pwr_med.90` dataset goes here
system.time(
  punc_recruit_pwr_med.90 <- puncture_lm_sim(
    n = 25,
    sim_iter = 500,
    beta_gen = function() {
      list(
...
usethis::use_data(punc_recruit_pwr_med.90, overwrite = TRUE)
