## code to prepare `type1_2var_uncor_n15_het` dataset goes here
type1_2var_uncor_n15_het <- puncture_lm_sim(
  n = 15,
  sim_iter = 10,
  beta_gen = function() {
...
usethis::use_data(type1_2var_uncor_n15_het, overwrite = TRUE)
